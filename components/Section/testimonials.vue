...
<template>
    <section class="px-4 py-20 mx-auto max-w-screen-2xl sm:px-8">
        <h1 class="max-w-2xl mx-auto text-3xl font-semibold text-center sm:text-4xl">We are trusted by many customers! Here
        ...
        <div class="grid grid-cols-1 mt-10 sm:grid-cols-3 gap-7">
            <div class="flex flex-col items-center gap-7 ">
                <div class="flex flex-col justify-around px-4 py-3 bg-white rounded-md shadow-lg grow">
                    ...
                    <div class="mt-5">
                        <span class="font-bold ">Paul Croke</span>
                ...
                <div class="flex flex-col justify-around px-4 py-3 bg-white rounded-md shadow-lg">
                    ...
                    <div class="mt-5">
                        <span class="font-bold">Mats Stigzelius</span>
                        <p class="mt-3 text-sm text-gray-500">Co-founder - Rainmaking</p>
                    </div>
                </div>
            </div>
            <!-- col 2 -->
            <div class="flex flex-col items-center gap-7 ">
                <div class="flex flex-col justify-around px-4 py-3 bg-white rounded-md shadow-lg">
                    ...
                    <div class="mt-5">
                        <span class="font-bold ">Bethany Stia</span>
                        <p class="mt-3 text-sm text-gray-500">Operation Lead - Campaign Marketing</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-around px-4 py-3 bg-white rounded-md shadow-lg">
                    ...
                    <p class="mt-5 font-medium text-gray-500">
                        ...
                        work ethic throughout the project have been commendable. I am actively seeking more projects to
                        leverage Qualyval's expertise and greatly appreciate the connection with them.
                    </p>
                    <div class="mt-5">
                        <span class="font-bold ">Oliver Hunter</span>
                        <p class="mt-3 text-sm text-gray-500">Financial Trader</p>
                    </div>
                </div>
            </div>
            <!-- col 3 -->
            <div class="flex flex-col items-center gap-7 ">
                <div class="flex flex-col justify-around px-4 py-3 bg-white rounded-md shadow-lg grow">
                    ...
                    <div class="mt-5">
                        <span class="font-bold ">Sagar Patil</span>
