<template>
    <div class="flex flex-col items-center px-4 py-10 mx-auto border-b max-w-screen-2xl sm:px-8 border-b-gray-200 ">
        ...
        <button type="button" hidden ref="openModalRef" data-modal-target="completation-modal"
            data-modal-toggle="completation-modal">
            toggle modal
        </button>
    </div>
    <!-- completation pop up-->
    <div id="completation-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full ">
            ...
            <div class="relative bg-white rounded-lg shadow">
                <button type="button" :class="{ 'hidden': isLoading }" ref="closeButtonRef"
                    ...
                    data-modal-hide="completation-modal">
